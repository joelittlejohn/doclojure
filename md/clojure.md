...
Clojure maps are functions of their keys (what is a map, other than a simple function that takes a key and returns a value?) so you can invoke a map like a function.
